...
def _set_text(
    ...
    for index, letter in enumerate(message):
        ...
        if letter == " " or letter in "0123456789" or letter == "\n":
            offset += 2 + scale
            continue
...
letters_dict = {
    ...
    "<": {
        "smallcaps": "000-000-040-400-060",
        "uppercase": "000-000-040-400-060",
        "lowercase": "000-000-040-400-060",
    },
    ">": {
        "smallcaps": "000-000-050-005-070",
        "uppercase": "000-000-050-005-070",
        "lowercase": "000-000-050-005-070",
    },
    "(": {
